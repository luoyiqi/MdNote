...
import com.xdsjs.mdnote.databinding.ActivityMainBinding;
import com.xdsjs.mdnote.viewModel.MainActVM;

public class MainActivity extends BaseActivity<MainActVM, ActivityMainBinding>
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setViewModel(new MainActVM());
        setBinding(DataBindingUtil.<ActivityMainBinding>setContentView(this, R.layout.activity_main));
        getBinding().setMainActVM(getViewModel());
        initView();
    }
